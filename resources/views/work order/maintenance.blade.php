...
$(document).ready(function () {
  ...
  var listnomor_polisi = []
	@foreach($Gps_installation as $row)
		listnomor_polisi.push('{{$row->no_polisi}}')
	@endforeach
...
// =========================================================    // 
	...
	var optnomor_polisi = ''
	for(var ii = 0; ii<listnomor_polisi.length; ii++){
		if(listnomor_polisi[ii] == data.val_detail[i].nomor_polisi){
			optnomor_polisi +='<option value='+ listnomor_polisi[ii] +' selected>' + listnomor_polisi[ii] + '</option>'
		}else{
			optnomor_polisi +='<option value='+ listnomor_polisi[ii] +'>' + listnomor_polisi[ii] + '</option>'
		}		
	}
	tr += '<td><select id="nomor_polisi_'+i+'" name="nomor_polisi" class="form-control" style="width:150px;">' + optnomor_polisi + '</select></td>';
