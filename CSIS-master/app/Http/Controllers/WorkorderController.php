...
class WorkorderController extends Controller
{
    ...
    {
        $install = BAP::with(['customer','gsm'])->get();     // untuk Nampilin field relasi relasi
