   ...
   <div class="card">
                    <div class="card-header"> </div>
                       <div class="card-body">
                        ...
                        <td>
                        <select  id="nomor_polisi" name="nomor_polisi[]"  class="form-control" >
                                         <option value="">-- choose Nomor Polisi --</option>
                                         @foreach ($Gps_installation as $nopol)
                                            <option value="{{$nopol->no_polisi}}">{{$nopol->no_polisi}}</option>
                                            @endforeach
                                    </select>
                        </td>
                        <td>
                        ...
                        <td>
                            <select  id="gsm_number" name="gsm_number[]"  class="form-control" >
                                         <option value="">-- choose Gsm Number --</option>
